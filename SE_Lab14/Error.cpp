...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(61, "Таблица лексем: ошибка при получении элемента по индексу, индекс за границами таблицы"),
		...
		ERROR_ENTRY(67, "Таблица идентификаторов: ошибка при получении элемента по индексу, индекс за границами таблицы"),
